...
{
    public partial class Team43LibraryContext : DbContext
    {
        public Team43LibraryContext()
        {
        }

        public Team43LibraryContext(DbContextOptions<Team43LibraryContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u0449300;Password=changeme;Database=Team43Library");
            }
        }
